...
#             assert self.bits_compress == 0
    ...
    def forward_train(self, graph_ids, node_feats=None, edge_feats=None,
        ...
        if self.has_edge_feats:
            if self.row_LSTM:
                edge_feats_embed = self.embed_edge_feats(edge_feats, list_num_edges=list_num_edges, db_info=db_info,edge_feats_lstm=edge_feats_lstm)
            else:
                edge_feats_embed = self.embed_edge_feats(edge_feats, list_num_edges=list_num_edges, db_info=db_info, rc=rc)
