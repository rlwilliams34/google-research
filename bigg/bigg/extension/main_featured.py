...
#         get_graph_stats(gt_graphs2, gt_graphs, cmd_args.g_type)
    ...
    for epoch in range(cmd_args.epoch_load, cmd_args.num_epochs):
        ...
        elif epoch >= epoch_lr_decrease and cmd_args.learning_rate == 1e-4:
            cmd_args.learning_rate = cmd_args.learning_rate / 10
            print("Lowering Larning Rate to: ", cmd_args.learning_rate)
            epoch_lr_decrease += 100
            for param_group in optimizer.param_groups:
        ...
        for idx in pbar:
            ...
            if len(batch_idx) == 1:
                print(train_graphs[batch_idx[0]].edges())
            ...
            if cmd_args.model == "BiGG_GCN":
                ...
                ll, ll_wt, ll_batch, ll_batch_wt, _ = model.forward_train(batch_indices, node_feats = node_feats, edge_feats = edge_feats, batch_idx = batch_idx, list_num_edges = list_num_edges, db_info = db_info_it, list_last_edge=list_last_edge)
