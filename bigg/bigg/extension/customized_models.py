    ...
    def embed_edge_feats(self, edge_feats, noise=0.0, prev_state=None, as_list=False):
        ...
        if self.method == "LSTM":
            if prev_state is None:
                ...
                prev_h = prev_h.reshape(prev_h.shape[0] * B, self.embed_dim)
                ...
                state_h = state_h.reshape(state_h.shape[0] * B, self.embed_dim)
                ...
                state_c = state_h.reshape(state_c.shape[0] * B, self.embed_dim)
