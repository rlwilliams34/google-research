...
class BiggWithEdgeLen(RecurTreeGen):
    def __init__(self, args):
        ...
        assert self.method in ['Test', 'MLP-Repeat', 'MLP-Multi', 'MLP-Double', 'LSTM', 'MLP-Leaf', 'Test2', 'Test3', 'Test4', 'Test5', 'Test6', 'Test7', 'Test8', 'Test9']
        ...
        if self.method == "Test9":
            ...
            self.leaf_embed = Parameter(torch.Tensor(1, args.embed_dim))
            self.empty_embed = Parameter(torch.Tensor(1, args.embed_dim))
